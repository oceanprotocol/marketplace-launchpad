...
Ocean Marketplace simplifies these steps by providing a user friendly interface. Go to the [Publish tutorial](https://docs.oceanprotocol.com/tutorials/marketplace-publish-data-asset/) to learn how to use Ocean Marketplace for publishing dataset.
...
Ocean also supports assets to be published freely. Free pricing is suitable for individuals and organizations working in the public domain and want their datasets to be freely available. Publishers can also choose this model if they publish assets with licenses that require them to make them freely available.

The page on [Pricing models](https://docs.oceanprotocol.com/concepts/asset-pricing/) explains more about the above mentioned asset pricing schemas.
...
- Go to [Download tutorial](https://docs.oceanprotocol.com/tutorials/marketplace-download-data-asset/) to learn how Ocean Market facilitates buying and downloading datasets.
