...
- Reads metadata events from blockchain and caches them
- All Aquarius instances will contain the same data -> load balancing, failover
- A single Aquarius instance can cache assets from mulitple blockchain networks
...
- Decrypts URL when the dataset is downloaded or a compute job is started
...
Ocean libraries come in two flavors:
